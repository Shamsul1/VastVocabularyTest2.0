...
public class AdvancedWordDatabase extends SQLiteOpenHelper{

    public static final String DATABASE_NAME = "AdvancedWordDatabase.db";
    ...
    public AdvancedWordDatabase(Context context) {
