...
public class IntermediatewordDatabase extends SQLiteOpenHelper{


    public static final String DATABASE_NAME = "IntermediateWordDatabase.db";
    public static final String TABLE_NAME = "Intermediate_table";
    ...
    public IntermediatewordDatabase(Context context) {
